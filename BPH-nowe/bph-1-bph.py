...
HEADER = '''BPH - Kursy walut: Dla Klientów Banku BPH (CHF)
...
def getRates(date):
    ...
    for hour in hours:
        ...
        url = f'https://www.bph.pl/pi/api/currency/tw0/currencies?date={date} {hour}'
        ...
        for entry in data:
            ...
            info += f'{date}\tCHF not found in entry from {hour}'
            continue

        row = (date, hour, buying, selling, spread)
